"""
Django settings for wangsit_backend project.
...
ROOT_URLCONF = 'wangsit_backend.urls'
...
WSGI_APPLICATION = 'wangsit_backend.wsgi.application'
...
SOCIAL_AUTH_LOGIN_ERROR_URL = '/api/auth/callback/?error=1'
